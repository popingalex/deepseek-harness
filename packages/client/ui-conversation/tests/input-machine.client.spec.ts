...
import { InputMachine, placeholderForLabel, projectClipboard } from '../src/client/input/machine.ts'
import { deriveDecorations, scanTextRefs } from '../src/client/input/decorations.ts'

// Every refOf label below is a short latin name, so placeholderForLabel lands
// them all in the narrowest width class; P is that one-char placeholder.
const P = placeholderForLabel('worker-1')
